...
Multi PHP 지원 (base php7.2) - 5.4, 5.5, 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2
모니터링 툴 - cockpit 지원
</pre>
...
httpd 2.4.37
php (base php7.2) 5.4, 5.5, 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2
mariadb 10.5.13
ionCube PHP Loader
Zend OPcache
Xdebug
...
clamav 와 php 8.2 버전업에 따른 수정 버전 입니다.
